...
export default function TwoStepRoomSelection() {
  ...
  const [textContent, setTextContent] = useState("1. Select a room type from the available options below to proceed.");
  ...
  useEffect(() => {
    if (currentPage === "select-rate") {
      setTextContent("2. Choose your preferred rate plan from the available options.");
    } else if (currentPage === "checkout") {
      setTextContent("3. Review your booking summary before completing your reservation.");
    } else {
      setTextContent("1. Select a room type from the available options below to proceed.");
    }
  }, [currentPage]);
